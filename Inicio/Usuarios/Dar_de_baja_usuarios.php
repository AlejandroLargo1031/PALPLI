...
<div class="rectangle" id="rectangulo-libros-almacenados"></div>
    ...
    <div class="rectangulo-bajausuarios">
    ...
    <div class="search-containerbaja">
        <input type="text" id="searchInputbaja" placeholder="Buscar...">
        <button id="searchButtonbaja">Buscar</button>
    </div>
    <div class="estado-container">
        <label for="estado"></label>
        <textarea id="estado" placeholder="MOTIVOS..."></textarea>
        <div class="fecha-proceso-container">
            <label for="fechaproceso">Fecha del proceso: <br></label>
            <input type="date" id="fechaproceso" class="fechaproceso" >
        </div>
         <div class="registrar-button-container">
        <button id="restaurarButton" class="button">Restaurar</button>
    </div>
        <div class="registrar-button-container">
